...
detector = cv2.CascadeClassifier(r"C:\Users\sgupt\Documents\faceunlock\Lock-Unlock-Laptop-PC-Screen-Using-Face-Recognition\haarcascade_frontalface_default.xml")
...
faces,ids = getImagesAndLabels(r'C:\Users\sgupt\Documents\faceunlock\dataset')  # Get the faces and IDs

recognizer.train(faces, np.array(ids)) # Train the model using the faces and IDs

assure_path_exists(r'C:\Users\sgupt\Documents\faceunlock\trainer')    # Save the model into trainer.yml
recognizer.save(r'C:\Users\sgupt\Documents\faceunlock\trainer\trainer.yml')
